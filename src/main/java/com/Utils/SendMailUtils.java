...
public class SendMailUtils {
     ...
     * 邮箱账号
     */
    public static final String EMALACCOUNT = "mzchat@163.com";
    /**
     * 密码
     */
    public static final String PASSWORD = "meizhuo";
    /**
     * 授权码
     */
    ...
    public static void sendMail(String code,String tomail) throws Exception {
        ...
        */
        ...
        //
        transport.connect(EMALACCOUNT, TOKEN);
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail,String code) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "mzchat", "UTF-8"));
